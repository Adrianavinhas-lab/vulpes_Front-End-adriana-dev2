...
import { Admin2View, CadernoView } from "./views";
...
export default function MiniDrawer(props: { title: React.ReactNode }) {
  ...
  return (
    <>
        ...
        <Toolbar className={classes.barra}>
          ...
          <div style={{ marginLeft: "auto", marginRight: 0, display: "flex" }}>
            ...
            >
              ...
              <Typography fontFamily="Candara">Vista Administrador</Typography>
            </Button>
      ...
      >
        ...
        <Divider />
        {/* <Admin2View /> */}
        {changeView ? <CadernoView /> : <Admin2View />}
      </Drawer>
    </>
  );
}

...
export interface IBalancoGH1 {
  id_balanco_GH1: number;
...
export const TabelaBalancoGH1: React.FC<IJaneiroGH1Props> = ({
  tabela,
  onInputChange,
}) => {
  ...
  //     Partial<Record<number, Partial<IBalancoGH1>>>
  //   >({});
  //   const [id] = useState(0);

  //   const [row, setRow] = useState<IBalancoGH1>({
  //     id_balanco_GH1: 0,

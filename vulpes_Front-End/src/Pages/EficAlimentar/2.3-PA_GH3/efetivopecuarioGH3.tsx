...
export interface IEfetivoPecuarioGH3 {
    id_efetivo_pecuarioGH3: number;
...
interface IPecuarioProps {
    tabela: IEfetivoPecuarioGH3;
  onInputChange: (event: ChangeEvent<HTMLInputElement>) => void;
}

export const EfetivoPecuarioEFGH3: React.FC<IPecuarioProps> = ({
    tabela,
  onInputChange,
}) => {
  ...
  const [, setEditedFields] = useState<
    Partial<Record<number, Partial<IEfetivoPecuarioGH3>>>
  >({});
  const [id] = useState(0);
  ...
  const handleNewRowsChange = (field: keyof IEfetivoPecuarioGH3, value: string | number) => {
  ...
  async function getTabelaCalendarioRega(): Promise<IEfetivoPecuarioGH3> {
    try {
  ...
  /********* CREATE *******************/
  async function criarTabela(tabela: IEfetivoPecuarioGH3): Promise<IEfetivoPecuarioGH3> {
    try {
             ...
             <table>
              <TableHead>
                <TableRow>
                  ...
                  >
                    Plano de Alimentação - Grupo Homogéneo 3
                  </TableCell>
                </TableRow>
                <TableRow>
                  <TableCell

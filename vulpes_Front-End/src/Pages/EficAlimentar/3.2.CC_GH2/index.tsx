...
import { IBalancoGH2, TabelaBalancoGH2 } from "./balancoGH2";
import { Typography } from "@material-ui/core";
import { IJaneiroGH2, TabelaJaneiroGH2 } from "./janeiroGH2";
import { IfevereiroGH2, TabelafevereiroGH2 } from "./fevereiroGH2";
import { ImarcoGH2, TabelamarcoGH2 } from "./marcoGH2";
import { IAbrilGH2, TabelaAbrilGH2 } from "./abrilGH2";
import { IMaioGH2, TabelaMaioGH2 } from "./maioGH2";
import { IJunhoGH2, TabelaJunhoGH2 } from "./junhoGH2";
import { IJulhoGH2, TabelaJulhoGH2 } from "./julhoGH2";
import { IAgostoGH2, TabelaAgostoGH2 } from "./agostoGH2";
import { ISetembroGH2, TabelaSetembroGH2 } from "./setembroGH2";
import { IOutubroGH2, TabelaOutubroGH2 } from "./outubroGH2";
import { INovembroGH2, TabelaNovembroGH2 } from "./novembroGH2";
import { IDezembroGH2, TabelaDezembroGH2 } from "./dezembroGH2";
...
export default function EF_CC_GH2() {
  const classes = useStyles();
  const [isloading] = useState(false);

  /******************* TABELA BALANÇO ********************/
  const [balanco, setBalanco] = useState<IBalancoGH2>({
    id_balanco_GH2: 0,
  ...
  /********************* TABELA JANEIRO ********************/
  const [janeiro, setJaneiro] = useState<IJaneiroGH2>({
    id_janeiro_GH2: 0,
  ...
  /******************** TABELA FEVEREIRO **********************/
  const [fevereiro, setFevereiro] = useState<IfevereiroGH2>({
    id_fevereiro_GH2: 0,
  ...
  /******************** TABELA MARCO **********************/
  const [marco, setMarco] = useState<ImarcoGH2>({
    id_marco_GH2: 0,
  ...
  /******************** TABELA ABRIL **********************/
  const [abril, setAbril] = useState<IAbrilGH2>({
    id_Abril_GH2: 0,
  ...
  /******************** TABELA MAIO **********************/
  const [maio, setMaio] = useState<IMaioGH2>({
    id_Maio_GH2: 0,
  ...
  /******************** TABELA JUNHO **********************/
  const [junho, setJunho] = useState<IJunhoGH2>({
    id_Junho_GH2: 0,
  ...
  /******************** TABELA JULHO **********************/
  const [julho, setJulho] = useState<IJulhoGH2>({
    id_Julho_GH2: 0,
  ...
  /******************** TABELA AGOSTO **********************/
  const [agosto, setAgosto] = useState<IAgostoGH2>({
    id_Agosto_GH2: 0,
  ...
  /******************** TABELA Setembro **********************/
  const [setembro, setSetembro] = useState<ISetembroGH2>({
    id_Setembro_GH2: 0,
  ...
  /******************** TABELA OUTUBRO **********************/
  const [outubro, setOutubro] = useState<IOutubroGH2>({
    id_Outubro_GH2: 0,
  ...
  /******************** TABELA NOVEMBRO **********************/
  const [novembro, setNovembro] = useState<INovembroGH2>({
    id_Novembro_GH2: 0,
  ...
  /******************** TABELA NOVEMBRO **********************/
  const [dezembro, setDezembro] = useState<IDezembroGH2>({
    id_Dezembro_GH2: 0,
  ...
  return (
    <div className={classes.root}>
      <CadernoLayout title="Grupo Homogêneo 2" />
        ...
        {isloading ? (
          ...
          <ThemeProvider theme={theme}>
            <TableContainer>
              ...
              <TabelaJaneiroGH2
                tabela={janeiro}
                onInputChange={handleInputChangejaneiro}
              />
              <TabelafevereiroGH2
                tabela={fevereiro}
                onInputChange={handleInputChangeFevereiro}
              />
              <TabelamarcoGH2
                tabela={marco}
                onInputChange={handleInputChangemarco}
              />
              <TabelaAbrilGH2
                tabela={abril}
                onInputChange={handleInputChangeAbril}
              />
              <TabelaMaioGH2
                tabela={maio}
                onInputChange={handleInputChangeMaio}
              />
              <TabelaJunhoGH2
                tabela={junho}
                onInputChange={handleInputChangeJunho}
              />
              <TabelaJulhoGH2
                tabela={julho}
                onInputChange={handleInputChangeJulho}
              />
              <TabelaAgostoGH2
                tabela={agosto}
                onInputChange={handleInputChangeAgosto}
              />
              <TabelaSetembroGH2
                tabela={setembro}
                onInputChange={handleInputChangeSetembro}
              />
              <TabelaOutubroGH2
                tabela={outubro}
                onInputChange={handleInputChangeOutubro}
              />
              <TabelaNovembroGH2
                tabela={novembro}
                onInputChange={handleInputChangeNovembro}
              />
              <TabelaDezembroGH2
                tabela={dezembro}
                onInputChange={handleInputChangeDezembro}
              />
            </TableContainer>
          </ThemeProvider>
        )}

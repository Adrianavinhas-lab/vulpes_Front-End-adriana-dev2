...
export interface IBalancoGH2 {
  id_balanco_GH2: number;
...
export const TabelaBalancoGH2: React.FC<IJaneiroGH2Props> = ({
  tabela,
  onInputChange,
}) => {
  ...
  //     Partial<Record<number, Partial<IBalancoGH2>>>
  //   >({});
  //   const [id] = useState(0);

  //   const [row, setRow] = useState<IBalancoGH2>({
  //     id_balanco_GH2: 0,

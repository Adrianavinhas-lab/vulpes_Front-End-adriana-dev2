...
import { IBalancoGH1, TabelaBalancoGH1 } from "./balancoGH1";
import { Typography } from "@material-ui/core";
import { IJaneiroGH1, TabelaJaneiroGH1 } from "./janeiroGH1";
import { IfevereiroGH1, TabelafevereiroGH1 } from "./fevereiroGH1";
import { ImarcoGH1, TabelamarcoGH1 } from "./marcoGH1";
import { IAbrilGH1, TabelaAbrilGH1 } from "./abrilGH1";
import { IMaioGH1, TabelaMaioGH1 } from "./maioGH1";
import { IJunhoGH1, TabelaJunhoGH1 } from "./junhoGH1";
import { IJulhoGH1, TabelaJulhoGH1 } from "./julhoGH1";
import { IAgostoGH1, TabelaAgostoGH1 } from "./agostoGH1";
import { ISetembroGH1, TabelaSetembroGH1 } from "./setembroGH1";
import { IOutubroGH1, TabelaOutubroGH1 } from "./outubroGH1";
import { INovembroGH1, TabelaNovembroGH1 } from "./novembroGH1";
import { IDezembroGH1, TabelaDezembroGH1 } from "./dezembroGH1";
...
export default function EF_CC_GH1() {
  const classes = useStyles();
  const [isloading, ] = useState(false);

  /******************* TABELA BALANÇO ********************/
  const [balanco, setBalanco] = useState<IBalancoGH1>({
    id_balanco_GH1: 0,
  ...
  /********************* TABELA JANEIRO ********************/
  const [janeiro, setJaneiro] = useState<IJaneiroGH1>({
    id_janeiro_GH1: 0,
...
/******************** TABELA FEVEREIRO **********************/
const [fevereiro, setFevereiro] = useState<IfevereiroGH1>({
  id_fevereiro_GH1: 0,
...
/******************** TABELA MARCO **********************/
const [marco, setMarco] = useState<ImarcoGH1>({
  id_marco_GH1: 0,
...
/******************** TABELA ABRIL **********************/
const [abril, setAbril] = useState<IAbrilGH1>({
  id_Abril_GH1: 0,
...
/******************** TABELA MAIO **********************/
const [maio, setMaio] = useState<IMaioGH1>({
  id_Maio_GH1: 0,
...
/******************** TABELA JUNHO **********************/
const [junho, setJunho] = useState<IJunhoGH1>({
  id_Junho_GH1: 0,
...
/******************** TABELA JULHO **********************/
const [julho, setJulho] = useState<IJulhoGH1>({
  id_Julho_GH1: 0,
...
/******************** TABELA AGOSTO **********************/
const [agosto, setAgosto] = useState<IAgostoGH1>({
  id_Agosto_GH1: 0,
...
/******************** TABELA Setembro **********************/
const [setembro, setSetembro] = useState<ISetembroGH1>({
  id_Setembro_GH1: 0,
...
/******************** TABELA OUTUBRO **********************/
const [outubro, setOutubro] = useState<IOutubroGH1>({
  id_Outubro_GH1: 0,
...
/******************** TABELA NOVEMBRO **********************/
const [novembro, setNovembro] = useState<INovembroGH1>({
  id_Novembro_GH1: 0,
...
/******************** TABELA NOVEMBRO **********************/
const [dezembro, setDezembro] = useState<IDezembroGH1>({
  id_Dezembro_GH1: 0,
...
const handleInputChangeDezembro = (event: ChangeEvent<HTMLInputElement>) => {
  ...
  return (
    <div className={classes.root}>
      <CadernoLayout title="Grupo Homogêneo 1" />
      <main className={classes.contents}>
        ...
        {isloading ? (
          ...
          >
            ...
            />
            <TabelaJaneiroGH1 tabela={janeiro} onInputChange={handleInputChangejaneiro} />
            <TabelafevereiroGH1 tabela={fevereiro} onInputChange={handleInputChangeFevereiro } />
            <TabelamarcoGH1 tabela={marco} onInputChange={handleInputChangemarco} />
            <TabelaAbrilGH1 tabela={abril} onInputChange={handleInputChangeAbril} />
            <TabelaMaioGH1 tabela={maio} onInputChange={handleInputChangeMaio} />
            <TabelaJunhoGH1 tabela={junho} onInputChange={handleInputChangeJunho} />
            <TabelaJulhoGH1 tabela={julho} onInputChange={handleInputChangeJulho} />
            <TabelaAgostoGH1 tabela={agosto} onInputChange={handleInputChangeAgosto} />
            <TabelaSetembroGH1 tabela={setembro} onInputChange={handleInputChangeSetembro} />
            <TabelaOutubroGH1 tabela={outubro} onInputChange={handleInputChangeOutubro} />
            <TabelaNovembroGH1 tabela={novembro} onInputChange={handleInputChangeNovembro} />
            <TabelaDezembroGH1 tabela={dezembro} onInputChange={handleInputChangeDezembro} />        
          </TableContainer>
          </ThemeProvider>
        )}
        <Box height={150}></Box>

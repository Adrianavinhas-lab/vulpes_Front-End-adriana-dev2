...
export interface IJaneiroGH3 {
  id_janeiro_GH3: number;
...
export const TabelaJaneiroGH3: React.FC<IJaneiroGH3Props> = ({
  tabela,
  onInputChange,
}) => {
  ...
  const [, setEditedFields] = useState<
    Partial<Record<number, Partial<IJaneiroGH3>>>
  >({});
  const [id, setId] = useState(0);

  const [row, setRow] = useState<IJaneiroGH3>({
    id_janeiro_GH3: 0,
  ...
  /********* CREATE *******************/
  async function criarTabela(tabela: IJaneiroGH3): Promise<IJaneiroGH3> {
    try {

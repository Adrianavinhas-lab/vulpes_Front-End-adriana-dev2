...
import {  AlimentoCompostoEFGH1, IAlimentoCompostoGH1 } from "./alimentocomposto";
import { EfetivoPecuarioEFGH1, IEfetivoPecuarioGH1 } from "./efetivopecuario";
import { INecessidadesNutriGH1, NecessidadesNutriEFGH1 } from "./necessidadesnutricionais";
import { INecessidadesNutriTotalGH1, NNutricionaisTotaisEFGH1 } from "./NecessidadesTotais";
...
export default function EF_PA_GH1() {
  ...
  const [efetivo, setEfetivo] = useState<IEfetivoPecuarioGH1>({
    id_efetivo_pecuario: 0,
  ...
  const [necessidades, setNecessidades] = useState<INecessidadesNutriGH1>({
    id_nessec_nutr: 0,
  ...
  const [totais, setTotais] = useState<INecessidadesNutriTotalGH1>({
    id_nutri_totais: 0,
  ...
  /************** ALIMENTOcOMPOSTO ****************************/
  const [alimento, setAlimento] = useState<IAlimentoCompostoGH1>({
    id_alim_compostoGH1: 0,

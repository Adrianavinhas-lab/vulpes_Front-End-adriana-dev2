...
export interface IEfetivoPecuarioGH1 {
    id_efetivo_pecuario: number;
...
interface IPecuarioProps {
    tabela: IEfetivoPecuarioGH1;
  onInputChange: (event: ChangeEvent<HTMLInputElement>) => void;
}

export const EfetivoPecuarioEFGH1: React.FC<IPecuarioProps> = ({
    tabela,
  onInputChange,
}) => {
  ...
  const [, setEditedFields] = useState<
    Partial<Record<number, Partial<IEfetivoPecuarioGH1>>>
  >({});
  const [id] = useState(0);
  ...
  const handleNewRowsChange = (field: keyof IEfetivoPecuarioGH1, value: string | number) => {
  ...
  async function getTabelaCalendarioRega(): Promise<IEfetivoPecuarioGH1> {
    try {
  ...
  /********* CREATE *******************/
  async function criarTabela(tabela: IEfetivoPecuarioGH1): Promise<IEfetivoPecuarioGH1> {
    try {
             ...
             <table>
              <TableHead>
                <TableRow>
                  ...
                  >
                    Plano de Alimentação - Grupo Homogéneo 1
                  </TableCell>
                </TableRow>
                <TableRow>
                  <TableCell

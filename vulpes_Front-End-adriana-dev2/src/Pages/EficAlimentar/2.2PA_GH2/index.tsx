...
import { EfetivoPecuarioEFGH2, IEfetivoPecuarioGH2 } from "./efetivopecuarioGH2";
import { INecessidadesNutriGH2, NecessidadesNutriEFGH2 } from "./necessidadesnutricionaisGH2";
import { INecessidadesNutriTotalGH2, NNutricionaisTotaisEFGH2 } from "./necessidadestotaisGH2";
import { AlimentoCompostoEFGH2, IAlimentoCompostoGH2 } from "./alimentocompostoGH2";
...
export default function EF_PA_GH2() {
  ...
  const [necessidades, setNecessidades] = useState<INecessidadesNutriGH2>({
    id_nessec_nutrGH2: 0,
  ...
  const [totais, setTotais] = useState<INecessidadesNutriTotalGH2>({
  ...
  /************** ALIMENTOcOMPOSTO ****************************/
  const [alimento, setAlimento] = useState<IAlimentoCompostoGH2>({

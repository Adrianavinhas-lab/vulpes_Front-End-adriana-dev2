...
export default function HomeViewTecnico(props: { title: React.ReactNode }) {
      ...
      >
        <Toolbar className={classes.barra}>
          ...
          <div style={{ marginLeft: "auto", marginRight: 0, display: "flex" }}>
            ...
            {/* {func_print('auth.user_role',auth)} */}
            {auth.user?.roles.includes('admin')  && (
              ...
              >
                ...
                <Typography fontFamily="Candara">Vista Consultor</Typography>
              </Button>
            )}
